"""
Модуль, демонстрирующий проблемы конкурентных платежей.
Содержит две реализации оплаты заказа:
pay_order_unsafe() - уязвимая версия (уровень READ COMMITTED без блокировок)
pay_order_safe() - защищенная версия (уровень REPEATABLE READ с блокировкой FOR UPDATE)
"""
